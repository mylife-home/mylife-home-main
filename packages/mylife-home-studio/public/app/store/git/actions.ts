...
export const gitCommit = createAsyncAction<ActionPayloads.GitCommit, GitDiff>(ActionTypes.COMMIT);
export const gitRestore = createAsyncAction<ActionPayloads.GitRestore, GitDiff>(ActionTypes.RESTORE);
