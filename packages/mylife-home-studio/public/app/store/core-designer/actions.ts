...
export const activateView = createAction<{ tabId: string; templateId: string; }>(ActionTypes.ACTIVATE_VIEW);
...
export const setTemplate = createAsyncAction<{ tabId: string; templateId: string; }>(ActionTypes.SET_TEMPLATE);
export const renameTemplate = createAsyncAction<{ templateId: string; newId: string }>(ActionTypes.RENAME_TEMPLATE); // Note: newId is new templateId only, not full id
export const clearTemplate = createAsyncAction<{ templateId: string[]; }>(ActionTypes.CLEAR_TEMPLATE);
export const setTemplateExport = createAsyncAction<{ templateId: string; exportType: 'config' | 'member'; exportId: string; componentId: string; propertyName: string; }>(ActionTypes.SET_TEMPLATE_EXPORT);
export const clearTemplateExport = createAsyncAction<{ templateId: string; exportType: 'config' | 'member'; exportId: string }>(ActionTypes.CLEAR_TEMPLATE_EXPORT);
