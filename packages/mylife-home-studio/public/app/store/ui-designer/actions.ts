...
export const newTemplate = createAsyncAction<ActionPayloads.NewTemplate>(ActionTypes.NEW_TEMPLATE);
export const clearTemplate = createAsyncAction<ActionPayloads.ClearTemplate>(ActionTypes.CLEAR_TEMPLATE);
export const renameTemplate = createAsyncAction<ActionPayloads.RenameTemplate>(ActionTypes.RENAME_TEMPLATE);
export const cloneTemplate = createAsyncAction<ActionPayloads.CloneTemplate>(ActionTypes.CLONE_TEMPLATE);
export const setTemplateProperties = createAsyncAction<ActionPayloads.SetTemplateProperties>(ActionTypes.SET_TEMPLATE_PROPERTIES);
