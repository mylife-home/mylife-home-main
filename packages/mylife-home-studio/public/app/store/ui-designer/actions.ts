...
export const setTemplateBulkPatterns = createAsyncAction<ActionPayloads.SetTemplateBulkPatterns>(ActionTypes.SET_TEMPLATE_BULK_PATTERNS);
...
export const newTemplateInstance = createAsyncAction<ActionPayloads.NewTemplateInstance>(ActionTypes.NEW_TEMPLATE_INSTANCE);
...
export const setTemplateInstanceBindings = createAsyncAction<ActionPayloads.SetTemplateInstanceBindings>(ActionTypes.SET_TEMPLATE_INSTANCE_BINDINGS);
