const content = [
  ...
  { name: 'openssh-7.5_p1-r8.82592cc7.apk',               size: 135796  },
  { name: 'openssh-client-7.5_p1-r8.6a52c85a.apk',        size: 959143  },
  { name: 'openssh-keygen-7.5_p1-r8.e4d7cd6d.apk',        size: 160964  },
  { name: 'openssh-sftp-server-7.5_p1-r8.9568a1ef.apk',   size: 35861   },
  { name: 'openssh-server-7.5_p1-r8.aec8e7aa.apk',        size: 289533  },
  { name: 'openssh-server-common-7.5_p1-r8.28e29585.apk', size: 4371    },
  ...
  { name: 'APKINDEX.78b10181.tar.gz',                     size: 762825  }, //'APKINDEX.70c88391.tar.gz' because we use fake repo
